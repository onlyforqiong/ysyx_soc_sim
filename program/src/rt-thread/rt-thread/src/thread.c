...
rt_err_t rt_thread_startup(rt_thread_t thread)
{
    ...
    {
        // rt_kprintf("start schedule\n");
        /* do a scheduling */
        rt_schedule();
        // rt_kprintf("end schedule\n");
    }
